...
class SelectionWidget<T> extends StatefulWidget {
  ...
  final Alignment? confirmButtonAligment;
...
class SelectionWidgetState<T> extends State<SelectionWidget<T>> {
  ...
  Widget _multiSelectionValidation() {
    ...
    Widget defaultValidation = Padding(
      ...
      child: Align(
        alignment: widget.confirmButtonAligment ?? Alignment.centerRight,
        child: ElevatedButton(
          onPressed: onValidate,
          child: Text(widget.confirmButtonText ?? "OK"),
        ),
      ),
    );
    ...
    showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              child: new Text(widget.confirmButtonText ?? "OK"),
              onPressed: () {
